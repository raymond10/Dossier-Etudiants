...
public class EmploiDuTempSQL {
	...
	/**affiche si l'emploi du temps est publié ou pas **/
	public String edtPubli(){
		String sql="SELECT EDT_PUBLIQ_$F AS PUBLI FROM GEST_UV.ADMIN_ETU";
		return sql;
	}
	
	/**appel de la fonction qui donne le détail de l'emploi du temps de l'étudiant **/
	...
	/**appel de la fonction qui affiche l'uv suivi dans l'emploi du temps de l'étudiant **/
	...
	/**appel de la fonction qui donne le nom prenom de l'étudiant suivant le même uv **/
