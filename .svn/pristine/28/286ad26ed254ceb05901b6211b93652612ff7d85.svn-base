...
public class LesURLs {
	 ...
	 * @return the gctcUrl
	 */
	public String getGctcUrl() {
		return gctcUrl;
	}

	/**
	 * @param gctcUrl the gctcUrl to set
	 */
	public void setGctcUrl(String gctcUrl) {
		this.gctcUrl = gctcUrl;
	}
